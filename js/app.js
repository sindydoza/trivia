...
document.getElementById("btnjugar").addEventListener("click",  function jugartrivia() {
    iniciarPartida =  confirm("¿Quieres jugar la trivia?");


    // Evaluamos las respuestas del usuario (para iniciar el juego)
    
    mostrarResultados.style.display = '';
    if (iniciarPartida == false) {//CASO 1; EN EL QUE EL USUARIO NO QUIERA JUGAR
